 ...
 */
@Slf4j
public class BrefUserInfoTokenServices implements ResourceServerTokenServices {
	...
	public BrefUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
